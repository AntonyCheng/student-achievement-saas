package top.sharehome.issuemodule.common.constant;
...
public interface CommonConstant {
    ...
    List<Integer> TENANT_STATUS_LIST = Arrays.asList(
            TENANT_STATUS_CENSOR,
            TENANT_STATUS_ENABLE,
            TENANT_STATUS_DISABLE,
            TENANT_STATUS_CENSOR_DISABLE
    );

    /**
     * 管理员信息更新状态（0表示待审核，1表示已通过，2表示未通过）
     */
    int MANAGER_INFO_UPDATE_STATUS_CENSOR = 0;
    int MANAGER_INFO_UPDATE_STATUS_ENABLE = 1;
    int MANAGER_INFO_UPDATE_STATUS_CENSOR_DISABLE = 2;
    List<Integer> MANAGER_INFO_UPDATE_STATUS_LIST = Arrays.asList(
            MANAGER_INFO_UPDATE_STATUS_CENSOR,
            MANAGER_INFO_UPDATE_STATUS_ENABLE,
            MANAGER_INFO_UPDATE_STATUS_CENSOR_DISABLE
    );

    /**
     * 学生状态(0表示正常，1表示转专业，2表示参军，3表示离校)
     */
    int STUDENT_STATUS_NORMAL = 0;
    int STUDENT_STATUS_CHANGE_MAJOR = 1;
    int STUDENT_STATUS_ARMY = 2;
    int STUDENT_STATUS_LEAVE = 3;
    List<Integer> STUDENT_STATUS_LIST = Arrays.asList(
            STUDENT_STATUS_NORMAL,
            STUDENT_STATUS_CHANGE_MAJOR,
            STUDENT_STATUS_ARMY,
            STUDENT_STATUS_LEAVE
    );
    ...
    int LEVEL_4 = 3;
    int LEVEL_5 = 4;
    List<Integer> LEVEL_LIST = Arrays.asList(
            LEVEL_1,
            LEVEL_2,
            LEVEL_3,
            LEVEL_4,
     ...
     * 手机的匹配表达式
     */
    String MATCHER_PHONE_REGEX = "^1(3\\d|4[5-9]|5[0-35-9]|6[2567]|7[0-8]|8\\d|9[0-35-9])\\d{8}$";
