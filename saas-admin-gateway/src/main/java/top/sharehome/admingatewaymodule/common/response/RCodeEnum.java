package top.sharehome.admingatewaymodule.common.response;
...
public enum RCodeEnum {
     ...
     * 用户上传源代码太大 D0128
     */
    USER_UPLOADED_CODE_IS_TOO_LARGE("D0128", "用户上传源代码太大"),

    /**
     * OSS删除对象异常 D0129
     */
    OSS_DELETES_OBJECTS_EXCEPTIONALLY("D0129", "OSS删除对象异常"),

    /**
     * 数据未发生变化 D0130
     */
    THE_DATA_HAS_NOT_CHANGED("D0130", "数据未发生变化"),

    /**
     * 用户状态不可被更改 D0131
     */
    THE_USER_STATUS_CANNOT_BE_CHANGED("D0131", "用户状态不可被更改"),
